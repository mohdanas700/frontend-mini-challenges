...
let board = document.querySelector("#board"); // Use #board to target id
const initSize = 3;
let size = initSize,
    score = 0,
    maxScore = +localStorage.getItem('maxScore') || 0, // Ensure fallback for maxScore
    clickAllowed = true;
...
function createBoard(board, size) {
    ...
    board.innerHTML = ""; // Clear board before appending
